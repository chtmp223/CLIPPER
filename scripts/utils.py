...
def prompt_claude(prompt, verbose=True, metadata={"model": "claude-3-5-sonnet@20240620", "temp": 1.0, "max_tokens": 4095}, system_message="You are a helpful assistant.", project_id=""): 
    ...
    if verbose: 
        print("Prompt usage:", message_dict['usage']['input_tokens'], f"${message_dict['usage']['input_tokens']/1000000*3}")
        print("Prompt usage:", message_dict['usage']['output_tokens'], f"${message_dict['usage']['output_tokens']/1000000*15}")
    return text_content.strip()

def format_batch_openai(prompts, input_fpath, output_fpath, metadata={"model": "gpt-4o-2024-08-06","max_tokens": 4095, "temp": 0.0, "top_p": 1.0, "system_message": "You are a helpful assistant."}): 
    '''
