...
Now, generate as many valid facts as possible based on the chapter outlines. Return “No meaningful fact" if there is no new valid fact. Present your facts in the following format:
